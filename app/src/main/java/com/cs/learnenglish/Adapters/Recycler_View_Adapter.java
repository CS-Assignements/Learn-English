...
public class Recycler_View_Adapter extends RecyclerView.Adapter<View_Holder>{
    List<Word> list = Collections.emptyList();
    Context context;
...
class View_Holder extends RecyclerView.ViewHolder {
    ...
    View_Holder(View itemView) {
        ...
        english = (TextView) itemView.findViewById(R.id.english_text_view);
        farsi = (TextView) itemView.findViewById(R.id.farsi_text_view);
